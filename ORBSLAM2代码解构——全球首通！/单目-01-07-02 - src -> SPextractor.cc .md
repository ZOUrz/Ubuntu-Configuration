...
- ### 3. include/Tracking.h
    ...
    - 然后加上成员变量 `mpORBextractorLeft`, `mpORBextractorRight` 和 `mpIniORBextractor` 的声明
...
- ### 5. CMakeLists.txt
    ...
    - 在文件以下位置进行修改, 将 `ORBextractor.cc` 源文件添加到库中
